  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-10">
      ...
      <div>
        ...
        <p className="text-slate-500 mt-1 font-medium italic">Here's a quick look at your current productivity state.</p>
      </div>

      {/* Stats Overview */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="relative overflow-hidden bg-white p-6 rounded-2xl shadow-sm border border-slate-100 group hover:shadow-xl transition-all duration-300">
        ...
        <div className="relative overflow-hidden bg-white p-6 rounded-2xl shadow-sm border border-slate-100 group hover:shadow-xl transition-all duration-300">
          ...
          <div className="relative z-10 flex items-center gap-4">
            ...
            <div>
              <p className="text-slate-500 text-xs font-bold uppercase tracking-wider">High Priority</p>
              <p className="text-3xl font-black text-rose-600">{highPriorityTasks}</p>
            </div>
          </div>
        </div>
      </div>
